              ...
              <div style={{ padding: 24 }}>
                ...
                >
                  {[
                    {
                      label: "Hospital name",
                      defaultValue: "St. Elizabeth Catholic Hospital",
                    },
                    ...
                    {
                      label: "Website",
                      defaultValue: "https://sech-gh.org",
                    },
                    {
                      label: "Address",
                      defaultValue: "Duayaw Nkwanta, Tano North District",
                    },
              ...
              <div style={{ padding: 24 }}>
                ...
                {[
                  ...
                  },
                  {
                    ...
                    desc: "Receive alerts via SMS (requires Twilio)",
                  },
                  {
                    key: "newBooking" as const,
                    label: "New booking alert",
                    desc: "Notify when a patient submits a new booking",
                  },
                  {
                    key: "cancellation" as const,
                    label: "Cancellation alert",
                    desc: "Notify when a booking is cancelled",
                  },
                  {
                    key: "daily" as const,
                    label: "Daily summary digest",
                    desc: "Morning email with the day's appointments",
                  },
                ].map((item) => (
                  <div
                    key={item.key}
                ...
                >
                  ...
                  <tbody>
                    {[
                      {
                        name: "Admin User",
                        email: "admin@sech-gh.org",
                        role: "Super Admin",
                        active: true,
                      },
                      {
                        name: "Dr. Kwame Asante",
                        email: "kwame@sech-gh.org",
                        role: "Editor",
                        active: true,
                      },
                      {
                        name: "Sr. Mary-Rose Adjei",
                        email: "mradjei@sech-gh.org",
                        role: "Viewer",
                        active: false,
                      },
                    ].map((u) => (
