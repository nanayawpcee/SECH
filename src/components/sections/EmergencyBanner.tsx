      ...
      <div className="container emergency-row">
        <div className="emergency-left">
          ...
          <div>
            ...
            <div className="emergency-sub">Our emergency team is always ready. Don't wait — call us immediately.</div>
          </div>
        </div>

        <a href={`tel:${SITE.phone}`} className="emergency-cta">{SITE.phone}</a>
      </div>
    </div>
  );
}
